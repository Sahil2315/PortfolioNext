    ...
    <div id="sect-about" className="bigSections w-full h-screen relative">
      ...
      <div className=" relative z-50 flex flex-col w-full h-full justify-center items-center">
        <div className="max-2xl:w-3/5 max-lg:w-4/5 max-sm:5/6 2xl:w-1/2">
          <span className="xl:text-3xl md:text-xl font-bold">About Me</span>
          <p className="xl:text-xl md:text-md font-semibold mt-8">
          ...
          <p className="xl:text-xl md:text-md font-semibold mt-4">
