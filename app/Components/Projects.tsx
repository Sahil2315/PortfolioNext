            ...
            <div className="flex flex-col mt-8">
              <div className="flex-1 flex flex-col p-4 rounded-xl bg-indigo-800/20">
                ...
                <div className="flex flex-row mt-4">
                  <span className="py-1 px-2 bg-black/50 rounded-xl">Python</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">FastAPI</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">React Native</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">DeepSeek R1</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">Gemini</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">TailwindCSS</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">AWS</span>
                </div>
              ...
              <div className="flex-1 flex flex-col p-4 rounded-xl bg-indigo-800/20 mt-8">
                ...
                <div>
                <div className="flex flex-row mt-4">
                  <span className="py-1 px-2 bg-black/50 rounded-xl">NodeJS</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">Express</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">ReactJS</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">Redux</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">TailwindCSS</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">React Native</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">Electron</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">AWS</span>
                </div>
                </div>
                <div className="flex flex-row items-center mt-4">
              ...
              <div className="flex-1 flex flex-col p-4 rounded-xl bg-indigo-800/20 mt-8">
                ...
                <div className="flex flex-row mt-4">
                  ...
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">Express</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">ReactJS</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">socket.io</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">TailwindCSS</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">Firebase</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">AWS</span>
                </div>
                <div className="flex flex-row items-center mt-4">
                  <div className="mr-10">
              ...
              <div className="flex-1 flex flex-col p-4 rounded-xl bg-indigo-800/20 mt-8">
                ...
                <div>
                <div className="flex flex-row mt-4">
                  <span className="py-1 px-2 bg-black/50 rounded-xl">NextJS</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">ReactJS</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">socket.io</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">TailwindCSS</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">Vercel</span>
                  <span className="py-1 px-2 bg-black/50 rounded-xl ml-4">AWS</span>
                </div>
                </div>
                <div className="flex flex-row items-center mt-4">
